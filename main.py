...
def draw_board(board):
    ...
    for c in range(COLUMN_COUNT):
        for r in range(ROW_COUNT):
            if board[r][c] == 1:
                pygame.draw.circle(screen, P1_COLOR, (int(c * SQUARESIZE + SQUARESIZE / 2), height - int(r * SQUARESIZE + SQUARESIZE / 2)), RADIUS)
            elif board[r][c] == 2:
                pygame.draw.circle(screen, P2_COLOR, (int(c * SQUARESIZE + SQUARESIZE / 2), height - int(r * SQUARESIZE + SQUARESIZE / 2)), RADIUS)
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEMOTION:
            ...
            if turn == 0:
                ...
                pygame.draw.circle(screen, P2_COLOR, (posx, int(SQUARESIZE/2)), RADIUS)
        pygame.display.update()
